...
seoul_geo_path = '/Users/keunwookim/Desktop/Python/Bigdata_flatform/project/hangjeongdong_서울특별시.geojson'
seoul_gdf = gpd.read_file(seoul_geo_path)

# 시설 데이터 로드
facilities_df = pd.read_csv('/Users/keunwookim/Desktop/Python/Bigdata_flatform/project/서울반려동물동반.csv', encoding='utf-8')
